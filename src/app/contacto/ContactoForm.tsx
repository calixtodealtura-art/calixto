        ...
        <div>
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Honeypot anti-bots: oculto para personas, los bots suelen completar todo */}
              <input
                type="text"
                name="website"
                value={form.website}
              ...
              <Field label="Motivo de consulta" id="subject">
                <select
                  id="subject"
                  name="subject"
                  required
...
function Field({ label, id, children }: { label: string; id: string; children: React.ReactNode }) {
  return (
    <div>
      <label htmlFor={id} className="block text-[11px] tracking-[0.15em] uppercase
